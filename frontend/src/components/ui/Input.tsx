        ...
        <div className="min-w-72 ">
          ...
          <div className="relative">
            ...
            <input
              ...
              step="0.01"
              className={`block w-full pl-5 py-2 border border-gray-300 h-10 dark:border-gray-700 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 `}
            />
          </div>
          {error?.message && (
      ...
      {type === 'text' && (
        <div className="min-w-72 ">
          ...
          <input
            ...
            name={name}
            onChange={onChange}
            className={`block w-full p-2 border h-10 border-gray-300`}
      ...
      {type === 'date' && (
        <div className="min-w-72 ">
          ...
          <input
            ...
            name={name}
            onChange={onChange}
            className={`block w-full h-10 py-2 px-2 border sm:text-sm border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 box-border`}
          />
        </div>
      )}
    </>
